...
public class OrthodromicDistanceCalculatorTest {
    ...
    public void testCalculate() {
        ...
        Distance distance = OrthodromicDistanceCalculator.calculate(sutA, sutB);

        System.out.println("---");
        System.out.println(String.format("Distance between %s and %s: %.1f%s",
            sutA, sutB, distance.getValue(), distance.getUnit().getAbbreviation()));
        System.out.println("---");

        assertEquals(597.0, distance.roundUp(0).getValue(), 0.0);
    }
}
